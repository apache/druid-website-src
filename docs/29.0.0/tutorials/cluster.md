...
[Download](https://www.apache.org/dyn/closer.cgi?path=/druid/29.0.0/apache-druid-29.0.0-bin.tar.gz)
the 29.0.0 release.
...
```bash
rsync -az apache-druid-29.0.0/ MASTER_SERVER:apache-druid-29.0.0/
```
