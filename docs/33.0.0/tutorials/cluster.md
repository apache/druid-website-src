...
[Download](https://www.apache.org/dyn/closer.cgi?path=/druid/33.0.0/apache-druid33.0.0-bin.tar.gz)
the 33.0.0 release.
...
```bash
rsync -az apache-druid-33.0.0/ MASTER_SERVER:apache-druid-33.0.0/
```
