...
[Download](https://www.apache.org/dyn/closer.cgi?path=/druid/30.0.0/apache-druid-30.0.0-bin.tar.gz)
the 30.0.0 release.
...
```bash
rsync -az apache-druid-30.0.0/ MASTER_SERVER:apache-druid-30.0.0/
```
