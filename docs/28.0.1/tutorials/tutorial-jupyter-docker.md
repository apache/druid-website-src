...
```bash
DRUID_VERSION=28.0.1 docker compose --profile druid-jupyter up -d
```
...
```bash
DRUID_VERSION=28.0.1 docker compose --profile all-services up -d
```
...
```bash
DRUID_VERSION=28.0.1 docker compose --profile kafka-jupyter up -d
```
...
```bash
DRUID_VERSION=28.0.1 docker compose --profile all-services -f docker-compose-local.yaml up -d
```
