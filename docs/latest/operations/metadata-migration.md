...
for [deep storage migration](./deep-storage-migration.md).
...
After initializing the tables, please refer to the [import commands](./export-metadata.md#importing-metadata) for your target database.
