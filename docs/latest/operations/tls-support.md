...
|`druid.server.https.keyStorePassword`|The [Password Provider](./password-provider.md) or String password for the Key Store.|none|yes|
...
|`druid.server.https.trustStorePassword`|The [password provider](./password-provider.md) or String password for the Trust Store.  Not needed if `requireClientCertificate` and `requestClientCertificate` are false.|none|no|
...
|`druid.server.https.keyManagerPassword`|The [Password Provider](./password-provider.md) or String password for the Key Manager.|none|no|
