...
* Multi-column `byRow` Cardinality can be replaced with a Theta or HLL sketch on a single [virtual column](./virtual-columns.md) that combines the individual input columns.
