...
according to the query [aggregation granularity](./granularities.md).
...
Returns the dimension value unchanged if the given [`SearchQuerySpec`](./searchquery.md#searchqueryspec)
...
[aggregation granularity](./granularities.md)
...
For more documentation on using lookups, please see [Lookups](./lookups.md).
