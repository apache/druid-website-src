...
These post-aggregators return the value produced by the specified [aggregator](./aggregations.md).

`fieldName` refers to the output name of the aggregator given in the [aggregations](./aggregations.md) portion of the query.
