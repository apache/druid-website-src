...
|dimensions|A JSON list of dimensions to do the groupBy over; or see [DimensionSpec](./dimensionspecs.md) for ways to extract dimensions. |yes|
...
|limitSpec|See [LimitSpec](./limitspec.md).|no|
|having|See [Having](./having.md).|no|
|granularity|Defines the granularity of the query. See [Granularities](./granularities.md)|yes|
