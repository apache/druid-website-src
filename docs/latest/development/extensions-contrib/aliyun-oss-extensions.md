...
Use the [pull-deps](./../../operations/pull-deps.md) tool shipped with Druid to install the `aliyun-oss-extensions` extension, as described [here](./../extensions.md#community-extensions) on middle manager and historical nodes.
