...
This Apache Druid extension enables Druid to ingest and understand the Protobuf data format. Make sure to [include](./../extensions.md#loading-extensions) `druid-protobuf-extensions` in the extensions load list.
