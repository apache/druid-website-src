...
This Apache Druid extension includes stat-related aggregators, including variance and standard deviations, etc. Make sure to [include](./../extensions.md#loading-extensions) `druid-stats` in the extensions load list.
