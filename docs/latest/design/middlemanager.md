...
The reason we have separate JVMs for tasks is for resource and log isolation. Each [Peon](./peons.md) is capable of running only one task at a time, however, a MiddleManager may have multiple Peons.
