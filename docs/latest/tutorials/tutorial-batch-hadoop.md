...
After the data load is complete, please follow the [query tutorial](./tutorial-query.md) to run some example queries on the newly loaded data.

## Cleanup

This tutorial is only meant to be used together with the [query tutorial](./tutorial-query.md).
