...
Automatic compaction works in most use cases and should be your first option. To learn more, see [Automatic compaction](./automatic-compaction.md).
...
For more information, see [Avoid conflicts with ingestion](./automatic-compaction.md#avoid-conflicts-with-ingestion).
