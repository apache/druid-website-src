...
[Download](https://www.apache.org/dyn/closer.cgi?path=/druid/32.0.1/apache-druid-32.0.1-bin.tar.gz)
the 32.0.1 release.
...
```bash
rsync -az apache-druid-32.0.1/ MASTER_SERVER:apache-druid-32.0.1/
```
