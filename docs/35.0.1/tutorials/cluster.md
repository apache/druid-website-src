...
[Download](https://www.apache.org/dyn/closer.cgi?path=/druid/35.0.1/apache-druid35.0.1-bin.tar.gz)
the 35.0.1 release.
...
```bash
rsync -az apache-druid-35.0.1/ MASTER_SERVER:apache-druid-35.0.1/
```
