...
[Download](https://www.apache.org/dyn/closer.cgi?path=/druid/26.0.0/apache-druid-26.0.0-bin.tar.gz)
the 26.0.0 release.
...
```bash
rsync -az apache-druid-26.0.0/ MASTER_SERVER:apache-druid-26.0.0/
```
