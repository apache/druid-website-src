...
[Download](https://www.apache.org/dyn/closer.cgi?path=/druid/29.0.1/apache-druid-29.0.1-bin.tar.gz)
the 29.0.1 release.
...
```bash
rsync -az apache-druid-29.0.1/ MASTER_SERVER:apache-druid-29.0.1/
```
