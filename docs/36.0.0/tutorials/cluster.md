...
[Download](https://www.apache.org/dyn/closer.cgi?path=/druid/36.0.0/apache-druid36.0.0-bin.tar.gz)
the 36.0.0 release.
...
```bash
rsync -az apache-druid-36.0.0/ MASTER_SERVER:apache-druid-36.0.0/
```
