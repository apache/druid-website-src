...
discussion about project development. To join, send an email `dev-subscribe@druid.apache.org`.
...
* **Meetups:** Check out Apache Druid on [meetup.com](https://www.meetup.com/topics/apache-druid/) for links to regular meetups in cities all over the world. If you're thinking of organising your own community meetup, we ask that you apply the project's [rules of engagement](/community/event-guidance).
...
* **Linen:** Check out the [Apache Druid community on Linen](https://www.linen.dev/s/apache-druid/c/troubleshooting) for a digital archive of Apache Druid Slack threads. 
While Slack limits message history to the last 90 days, you can continue to access older threads on Linen.
* **Struct:** Check out [Apache Druid on Struct](https://druid.struct.ai/kb) for AI-generated knowledge base from Apache Druid Slack threads. 
...
| [Atul Mohan](https://github.com/a2l007)                   | [Apple](https://www.apple.com)                     |
| [Brian Le](https://github.com/317brian)                   | [Imply](https://imply.io/)                         |
...
| [Charles Smith](https://github.com/techdocsmith)          | [Imply](https://imply.io/)                         |
...
| [Maytas Monsereenusorn](https://github.com/maytasm)       | [Netflix](https://www.netflix.com/)                |
